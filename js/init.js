...
document.addEventListener("DOMContentLoaded", function() {
    const modalBox = document.querySelector(".iknow_tm_modalbox");
    const modalContent = document.querySelector(".iknow_tm_modalbox .box_inner");
    const closeBtn = document.querySelector(".iknow_tm_modalbox .close a");
